    ...
    <Card className="w-full max-w-md mx-auto mt-4">
      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <p className="text-sm"><strong>Token:</strong> {token}</p>
          <p className="text-sm"><strong>Bus ID:</strong> {busId}</p>
        </div>

        <Button onClick={testConnection} className="w-full" disabled={connectionStatus === "connecting"}>
